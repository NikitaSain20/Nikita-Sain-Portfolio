...
export default function Navigation() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      {
        threshold: [0, 0.01, 0.05, 0.1, 0.25, 0.5, 0.75, 1], // detect even tiny visibility
        rootMargin: "0px 0px -60% 0px", // triggers when section's top enters lower 40% of viewport
      }
    );

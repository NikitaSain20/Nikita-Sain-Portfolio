...
type SectionTheme = "home" | "about" | "skills" | "projects" | "experience" | "contact"
...
export function SectionThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  return <SectionThemeContext.Provider value={{ currentTheme, setTheme }}>{children}</SectionThemeContext.Provider>
}
